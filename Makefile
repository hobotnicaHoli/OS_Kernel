...
LIBS = \
  ...
  #koje biblioteke se koriste u prevodjenju, inicijalno sve tri koristis - treba da ih napravis(samo mem i console)
  #hw ne diras, ako neku od ove dve gore navedene ne napravis, moras da je ostavis ovde
  #treba u izvornom c kodu da implementiras ove dve biblioteke i onda ih iskljucujes odavde

#donji desni ugao konzole, imas make koji kad otvoris
#mozes da vidis sve komande koje mozes da odradis dvoklikom
#iznad svake komande sam napisala sta radi
...
#resetuje project base na njegovo osnovno stanje
clean:
...
#pokretanje emulatora za program koji je prethodno preveden
qemu: ${KERNEL_IMG}
	${QEMU} ${QEMUOPTS}
